export const MOCK_PRODUCTS = [
  ...
  },
  {
    ...
    price: 64,
    description:
      'USB 3.0 and USB 2.0 Compatibility Fast data transfers Improve PC Performance High Capacity; Compatibility Formatted NTFS for Windows 10, Windows 8.1, Windows 7; Reformatting required for other operating systems; Compatibility may vary depending on user’s hardware configuration and operating system',
  ...
  },
  {
    ...
    price: 109,
    description:
      'Easy upgrade for faster boot up, shutdown, application load and response (As compared to 5400 RPM SATA 2.5” hard drive; Based on published specifications and internal benchmark testing tests using PCMark vantage and Storage Mark application benchmarks)',
    category: 'electronics',
  ...
  },
  {
    ...
    price: 999.99,
    description:
      '49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration provides stunningly realistic and accurate visual reproduction',
    category: 'electronics',
...
export default { MOCK_PRODUCTS, MOCK_CATEGORIES }
